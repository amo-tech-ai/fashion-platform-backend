...
```bash
git remote add encore encore://fashion-platform-backend-h7a2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/fashion-platform-backend-h7a2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/fashion-platform-backend-h7a2/settings/integrations/github)
